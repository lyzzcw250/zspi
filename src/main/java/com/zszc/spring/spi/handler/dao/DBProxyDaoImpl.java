...
public class DBProxyDaoImpl implements DBProxyDao {
    ...
    public String getService(String proxy) {
        ...
        try {
            return sqlSession.selectOne("com.zszc.spring.spi.handler.dao.DBProxyMapper.getService",proxy);
        } finally {
            sqlSession.close();
        }
    }
    ...
    public List<DBProxy> getAllServices() {
        SqlSession sqlSession = sqlSessionFactory.openSession(false);
        try {
            return sqlSession.selectList("com.zszc.spring.spi.handler.dao.DBProxyMapper.getAllServices");
        } finally {
            sqlSession.close();
        }
    }
